		...
		value: function quick(trafficLights) {
			if ('browser' in process && process.browser) {
				for (var direction in trafficLights) {
					var elementId = trafficLights[direction].name;
					var color = trafficLights[direction].color;
...
var _Lights = __webpack_require__(151);
...
var Flow = function () {
	function Flow(config) {
		...
		this.config = config;
		this.lights = new _Lights2.default(config);
					...
					while (1) {
						switch (_context.prev = _context.next) {
							case 0:
								...
								_context.next = 5;
								return this.sleep(this.config.getGreenLightDuration());

							case 5:
								this.lights.setYellowLights();
								_context.next = 8;
								return this.sleep(this.config.getYellowLightDuration());
...
// 19.1.2.4 / 15.2.3.6 Object.defineProperty(O, P, Attributes)
$export($export.S + $export.F * !__webpack_require__(50), 'Object', {defineProperty: __webpack_require__(54).f});

/***/ }),
/* 339 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = !__webpack_require__(50) && !__webpack_require__(139)(function(){
